(
  ...
  console.log(args);
  let { doHighlightElements, focusHighlightIndex, viewportExpansion, debugMode } = args;
  ...
  function highlightElement(element, index, parentIframe = null) {
    console.log("highlightElement", element, index, parentIframe);
        ...
        if (nodeData.isTopElement) {
          ...
          if (nodeData.isInteractive) {
            ...
            if (doHighlightElements) {
              console.log("highlightElement", node, nodeData.highlightIndex, focusHighlightIndex);
